    ...
    <div ref={containerRef} className="relative md:h-[100svh] md:overflow-hidden">
      ...
      >
        {steps.map((step, i) => (
          ...
          >
            <article className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm md:p-8">
              ...
              <h4 className="mt-3 font-mono text-sm text-foreground/60" lang={locale}>
                {step.title}
              </h4>
