    ...
    <footer className="border-t border-border/50 bg-background/50 backdrop-filter backdrop-blur-sm">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-3 md:px-6">
        ...
        <div className="space-y-3">
          <Link href="/" className="inline-flex transition-opacity hover:opacity-80" aria-label="Accueil">
            <Image
        ...
        <nav aria-label="Footer">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><Link href="/about"    className="text-foreground/65 hover:text-foreground transition-colors">{tNav("about")}</Link></li>
            <li><Link href="/projects" className="text-foreground/65 hover:text-foreground transition-colors">{tNav("projects")}</Link></li>
            <li><Link href="/meetings" className="text-foreground/65 hover:text-foreground transition-colors">{tNav("meetings")}</Link></li>
            <li><Link href="/contact"  className="text-foreground/65 hover:text-foreground transition-colors">{tNav("contact")}</Link></li>
          </ul>
        </nav>
